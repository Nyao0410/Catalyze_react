...
exports.DynamicQuotaCalculator = void 0;
const date_fns_1 = require("date-fns");
class DynamicQuotaCalculator {
    /**
     * 計算エントリポイント
     * @param plan
     * @param sessions - 昨日までのセッション
     */
    calculate(plan, sessions) {
        ...
        const deadline = (0, date_fns_1.startOfDay)(plan.dynamicDeadline ?? plan.deadline);
        // 指定期間内の学習日数を数える（plan.studyDays は 1=Mon..7=Sun）
        let studyDaysCount = 0;
        try {
            const days = (0, date_fns_1.eachDayOfInterval)({ start: today, end: deadline });
    ...
    _calculateAveragePerformanceFactor(sessions) {
        if (sessions.length === 0)
            return DynamicQuotaCalculator.NEUTRAL_PERFORMANCE_FACTOR;
...
exports.DynamicQuotaCalculator = DynamicQuotaCalculator;
DynamicQuotaCalculator.NEUTRAL_PERFORMANCE_FACTOR = 9.0; // difficulty=3, concentration=3 相当の基準
//# sourceMappingURL=dynamic-quota-calculator.js.map