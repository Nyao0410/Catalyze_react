...
exports.ReviewItemEntity = void 0;
...
class ReviewItemEntity {
     ...
     * 次回復習までの日数
     */
    get daysUntilNextReview() {
        const today = (0, date_fns_1.startOfDay)(new Date());
        const nextDate = (0, date_fns_1.startOfDay)(this.nextReviewDate);
        return (0, date_fns_1.differenceInDays)(nextDate, today);
    }
    /**
     * 復習期限が過ぎているか
     */
    get isOverdue() {
        const today = (0, date_fns_1.startOfDay)(new Date());
        const nextDate = (0, date_fns_1.startOfDay)(this.nextReviewDate);
        return (0, date_fns_1.isAfter)(today, nextDate);
    }
    /**
     * 今日復習すべきか
     */
    get isDueToday() {
        const today = (0, date_fns_1.startOfDay)(new Date());
        const nextDate = (0, date_fns_1.startOfDay)(this.nextReviewDate);
        return (0, date_fns_1.isSameDay)(today, nextDate) || (0, date_fns_1.isAfter)(today, nextDate);
    }
    /**
     * 復習実施後の更新（SM-2アルゴリズム）
     *
    ...
    recordReview(quality) {
        ...
        if (quality < 3) {
            return new ReviewItemEntity({
                ...this.toProps(),
                lastReviewDate: now,
                nextReviewDate: (0, date_fns_1.addDays)(now, 1),
                repetitions: 0,
                intervalDays: 1,
            });
        }
        ...
        return new ReviewItemEntity({
            ...this.toProps(),
            lastReviewDate: now,
            nextReviewDate: (0, date_fns_1.addDays)(now, newInterval),
     ...
     */
    calculateNewEaseFactor(quality) {
...
exports.ReviewItemEntity = ReviewItemEntity;
//# sourceMappingURL=review-item-entity.js.map