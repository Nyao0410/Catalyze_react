...
export class MultiRoundPlanner {
  ...
  buildDifficultyMap(
    totalUnits: number,
    difficulties: number[],
    chunkSize = MultiRoundPlanner.DEFAULT_CHUNK_SIZE,
    threshold = MultiRoundPlanner.DEFAULT_THRESHOLD
  ): DifficultyChunk[] {
    const chunks: DifficultyChunk[] = [];
