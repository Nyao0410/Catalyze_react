...
import { RootNavigator } from './catalyze_app/src/presentation/navigation';
import { seedMockData } from './catalyze_app/src/infrastructure/mockData';
import { ThemeProvider, useTheme } from './catalyze_app/src/presentation/theme/ThemeProvider';
import { TopToastProvider } from './catalyze_app/src/presentation/hooks/useTopToast';
import './catalyze_app/src/locales'; // i18nの初期化
import { t } from './catalyze_app/src/locales';
import {
  planRepository,
  sessionRepository,
  reviewRepository,
} from './catalyze_app/src/services';
import { AccountService, SocialService } from './catalyze_app/src/application/services';
import { getCurrentUserId, isUserLoggedIn, onAuthStateChange, getCurrentUser } from './catalyze_app/src/infrastructure/auth';
